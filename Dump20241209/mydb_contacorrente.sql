...
CREATE TABLE `contacorrente` (
  ...
  KEY `fk_ContaCorrente_Cliente1_idx` (`Cliente_idCliente`),
  CONSTRAINT `fk_ContaCorrente_Cliente1` FOREIGN KEY (`Cliente_idCliente`) REFERENCES `cliente` (`idCliente`)
...
-- Dump completed on 2024-12-09 10:55:45
